...
cotacao_moedas_dolar <- 
  ...
  bind_rows( tibble(country = "China, People's Republic of", data = as.Date("2025-09-01"), cotacao= 0.1406687))  %>%
...
dados_grafico<- 
  ...
  mutate(country = case_when(
    ...
    str_detect(country, "Mex") ~ "México",
    str_detect(country, "Col") ~ "Colômbia",
    country == "China, People's Republic of" ~ "China",
    .default = country
  ))

paises_sel <- c("Argentina", "Brasil",  "China",  "Colômbia",    "México",    "Rússia"  ) 
...
dados_grafico %>%
  ...
  scale_color_manual(values = c("#74ACDF", "#009739", "#A51C30","#0033A0","#007A74", "#D52B1E")) +
  ...
  labs(
    ...
    subtitle = paste0("Segunda maior valorização do G20 e maior da América Latina"),
    caption = "Fontes: FMI, Banco Central da Argentina e Banco da China. Elaboração: Fernando Barbalho"
  )
